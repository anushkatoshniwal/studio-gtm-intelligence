        ...
        <section className="workspace-card experiment-card" aria-labelledby="experiment-title">
          ...
          <div className="experiment-inputs">
            <div className="conversion-column baseline-column">
              <p className="input-group-label">Baseline</p>
              <span>What are we starting from?</span>
            ...
            <div className="conversion-column expected-column">
              <p className="input-group-label">Expected</p>
              <span>What are we testing?</span>
              <div className="question-stack">
              <NumberField
              ...
              <label className="rationale-field" htmlFor="experiment-rationale">
                ...
                />
                <small>
                  Why do you believe this outcome is achievable?
                </small>
              </label>
              </div>
            </div>
            <div className="experiment-scope">
              <NumberField
                id="pilot_size"
                label="Test scope"
            ...
            <p className="evidence-note">
              Confidence and feasibility are operator judgments.
            </p>
            </div>
          </div>
      ...
      {isEditing ? (
        ...
        <div className="opportunity-content">
          ...
          <details className="full-context opportunity-context">
            ...
            <p><strong>Experiment hypothesis</strong><br />{context.hypothesis}</p>
    ...
    <section className="workspace-card economics-card" aria-labelledby="economics-title">
      ...
      {result && !isLoading ? (
        <div className="impact-flow">
          <ImpactNode symbol="◎" value={formatNumber(pilotSize)} label="Pilot accounts" />
      ...
      <details className="disclosure economics-disclosure">
        <summary>
          <strong>View full economics</strong>
          <span className="disclosure-action">→</span>
        </summary>
